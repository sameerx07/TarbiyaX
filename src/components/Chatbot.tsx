      ...
      <AnimatePresence>
              {isOpen && (
                <motion.div
                  ...
                  className="fixed bottom-[calc(7rem+env(safe-area-inset-bottom))] right-4 w-[95vw] sm:w-96 z-50 glass-card shadow-2xl flex flex-col h-[500px]"
                >
                  {/* Header */}
                  <div className="p-4 border-b border-border flex items-center gap-4">
                    <img
                      src="images/Livechatbot.gif"
                      alt="Chatbot GIF"
